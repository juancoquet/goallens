...
def prediction_list_view(request):
    ...
    predictions = Prediction.objects.all().order_by('-fixture__date', '-fixture__time', 'fixture__home__name', 'fixture__away__name')
    if season_q:
    ...
    if order_q == 'asc':
        predictions = predictions.order_by('fixture__date', 'fixture__time', 'fixture__home__name', 'fixture__away__name')
    elif order_q == 'desc':
        predictions = predictions.order_by('-fixture__date', '-fixture__time', 'fixture__home__name', 'fixture__away__name')
...
def prediction_upcoming_view(request):
    ...
    upcoming_preds = Prediction.objects.filter(fixture__date__gte=today).order_by(
        'fixture__date', 'fixture__time', 'fixture__home__name', 'fixture__away__name')
